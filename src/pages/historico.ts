...
export function initHistorico(): void {
  ...
  function criarItemTransacao(transacao: Transacao): HTMLLIElement {
  ...
  function updateListaTransacoes(): void {
    ...
    document.querySelectorAll<HTMLButtonElement>('.remover-transacao').forEach((btn) => {
      btn.onclick = (e) => {
